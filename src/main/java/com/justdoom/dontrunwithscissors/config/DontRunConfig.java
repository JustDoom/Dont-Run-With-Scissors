...
public class DontRunConfig {
    ...
    public static void init(File file) {
        ...
        cancel_sprinting = config.getBoolean("cancel-sprinting",
                category,
                false,
                "Cancel the players spring if they try to run with scissors. Default false");

        cancel_sprinting_message = config.getString("cancel-sprinting-message",
                category,
